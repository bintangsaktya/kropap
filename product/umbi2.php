...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green"> Promo Regular <span class="w3-yellow"> Rp10.200</span></h2>
    <div class="w3-display-container mySlides">
    <img src="../images/kenma.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
   ...
   Kentang asli dan murni asal Ngantang, kabupaten malang, jawa timur
    <hr>
