...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green"> Jagung <span class="w3-yellow"> Rp6000/kg</span></h2>
    <div class="w3-display-container mySlides">
    <img src="../images/jagung.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-row-padding w3-section">
    <div class="w3-col s3">
      <img class="demo w3-opacity w3-hover-opacity-off" src="../images/jagung.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(1)" title="Ilustrasi">
    </div>
  ...
  <div class="w3-container">
   ...
   Jagung murni dari petani wagir bapak hadi teguh prawito
    <hr>
